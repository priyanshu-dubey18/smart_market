  ...
  <div class="auth-page">
    ...
    <div class="auth-container">
      ...
      <div class="auth-card">
        ...
        <div class="card-top">
          <div class="user-badge customer-badge">
        ...
        <form @submit.prevent="handleSubmit" class="auth-form">
          ...
          <button type="submit" class="submit-btn" :class="{ loading }" :disabled="loading">
            <span v-if="!loading">Send OTP & Continue →</span>
...
.orb-1 { width: 500px; height: 500px; background: #6366f1; top: -150px; left: -150px; animation: orbFloat 8s ease-in-out infinite; }
.orb-2 { width: 350px; height: 350px; background: #06b6d4; bottom: -50px; right: 5%; animation: orbFloat 10s ease-in-out infinite reverse; }
.grid-overlay {
...
.back-btn {
  ...
  font-size: 0.9rem; cursor: pointer; margin-bottom: 1.5rem;
  transition: color 0.2s; padding: 0; display: block;
}
...
.input-wrap input {
  ...
  color: #f1f5f9; font-size: 0.95rem; padding: 0.85rem 0;
  font-family: inherit;
}
